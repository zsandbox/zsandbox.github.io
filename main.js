...
var HeroSearchComponent = /** @class */ (function () {
    ...
    HeroSearchComponent.prototype.ngOnInit = function () {
        ...
        // switch to new search observabvle each time the term changes
...
module.exports = "<h2>My Heroes</h2>\n\n<div>\n  <label>Hero name:\n    <input #heroName />\n  </label>\n  <button (click)=\"add(heroName.value); heroName.vale=''\">\n    add\n  </button>\n</div>\n\n<ul class=\"heroes\">\n  <li *ngFor=\"let hero of heroes\">\n    <a routerLink=\"/detail/{{hero.id}}\">\n      <span class=\"badge\">{{hero.id}}</span>\n      {{hero.name}}</a>\n      <button class=\"delete\" title=\"delete hero\" (click)=\"delete(hero)\">x</button>\n  </li>\n</ul>"
...
var HeroesComponent = /** @class */ (function () {
    // putting as parameter both defines a property AND identifies it
    // as an injection site <-- The dependency injection from Angular will
    // create an instance of the service when the constructor is called.
...
module.exports = __webpack_require__(/*! /Users/Zachi_Mac13in_1/Dropbox/zTypeScript/Projects/angular-tour-of-heroes/src/main.ts */"./src/main.ts");
